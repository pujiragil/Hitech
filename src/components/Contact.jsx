...
import { AiFillLinkedin, AiOutlineInstagram, AiOutlinePhone, AiOutlineWhatsApp } from 'react-icons/ai'
    ...
    <div className="bg-white">
      <div className="container mx-auto">
        <div className="flex flex-col font-open text-zinc-900 py-6">
          ...
          <div className="flex mx-6 md:flex-row lg:justify-evenly md:justify-between sm:flex-col sm:items-center">
            <div className="relative hidden md:block flex w-1/2 lg:w-4/12 h-full mx-4">
              <img className="h-full lg:h-10/12 z-10 relative" src={contactSvg} alt="svg" />
              <div className="absolute inset-0 w-1/2 rounded-full bg-zinc-400"></div>
            </div>
            <div className="flex sm:w-9/12 md:w-1/2 lg:w-2/5 flex-col bg-zinc-900 p-6 w-full rounded-large text-white drop-shadow-2xl">
              ...
              <div className="field flex flex-col">
                ...
                <textarea className="text-sm px-4 py-3 h-32 rounded-lg text-zinc-900 focus:outline-none focus:border-none mb-2" name="message" placeholder="Message..." />
              </div>
          ...
          <div className="flex md:hidden flex-col bg-white text-zinc-900 sm:w-2/5 w-3/5 font-open mx-6 mt-12 p-4">
