...
const Card = ({ primary, textColor, buttonText, buttonBg, textWhite,buttonHov }) => {
  return (
    <div className={`${ primary ? 'bg-white' : 'bg-zinc-900' } w-full ${textColor} shadow-2xl rounded-large flex flex-col p-6 mb-6`}>
