      ...
      <div className="container mx-auto px-6">
        <div className="font-open h-screen lg:h-desk flex flex-col justify-evenly items-center">
          ...
          <div className="flex relative justify-center items-center">
            <div className="medium:before:-top-6 medium:before:w-full medium:before:-left-6 before:-top-4 before:-right-1 before:left-1 before:bottom-1 before:border-2 before:border-zinc-900 before:w-10/12 before:h-full before:absolute w-10/12 medium:w-full">
              <img className="relative grayscale cursor-pointer hover:grayscale-0 duration-300 w-full" src="https://images.unsplash.com/photo-1590959651373-a3db0f38a961?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=739&q=80" alt="" />
            </div>
          </div>
        </div>
      </div>
