const Section = ({ imgFirst, subtitle, title, text, textButton, imgLink }) => {
  return (
      ...
      <div className="container mx-auto px-6">
        <div className="font-open h-screen lg:h-desk flex lg:flex-row flex-col justify-evenly items-center">
          <div className={`${imgFirst ? 'order-2 text-right items-end' : 'order-1'} shrink flex flex-col`}>
            ...
            <a href="#service" className="bg-zinc-900 text-base hover:bg-zinc-700 duration-300 font-bold w-fit text-white medium:px-10 px-9 medium:py-4 py-3 rounded-full drop-shadow-xl">{textButton}</a>
          </div>
