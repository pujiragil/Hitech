  ...
  return (
    <div className="bg-white" id="hero">
      <div className="container mx-auto border-b">
        <div className="flex flex-col px-6 font-roboto justify-center items-center font-open h-md lg:h-hero">
          ...
          <Link to="testimonials" spy={true} smooth={true} duration={700} className="px-10 py-4 sm:px-12 sm:py-4 rounded-full border-2 text-xl border-zinc-900 mt-6 cursor-pointer hover:bg-zinc-900 hover:text-white hover:drop-shadow-2xl duration-300">Get Started</Link>
        </div>
      </div>
    </div>
  )
