...
const Navbar = () => {
  ...
  return ( 
    <div className="container mx-auto relative font-roboto">
      ...
      <nav className="flex z-50 relative items-center justify-between h-20 bg-white px-6">
        ...
        <ul className="hidden md:block md:flex md:justify-center md:items-center">
          <li><Link className="px-6 py-3 mr-4 border border-transparent hover:border-zinc-900 hover:rounded duration-300" to="login">Login</Link></li>
          <li><Link className="px-6 py-3 bg-zinc-900 rounded text-white border border-transparent hover:bg-zinc-800 duration-300" to="register">Register</Link></li>
        </ul>
      </nav>
    </div>
  )
